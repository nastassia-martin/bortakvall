...
rowEl?.addEventListener('click', e => {
  ...
  if (clickedItem.tagName !== "DIV" && clickedItem.className !== "clr-button") {
    ...
    <div class="container">
      <div class="row">        
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 modal-body text-center">
          ...
          <button id="modal-product-num${products[index].id}" class="text-center clr-button modal-button" tabindex="-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    if (products[index].stock_status === "outofstock") {
      document
        .querySelector(`#modal-product-num${products[index].id}`)!
        .setAttribute("disabled", "disabled")
    }
